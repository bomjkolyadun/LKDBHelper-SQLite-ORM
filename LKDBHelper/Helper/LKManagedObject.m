...
@implementation LKManagedObject

+ (NSInteger)rowCountInContext:(LKDBContext*)context withPredicate:(id)where{
    return [context rowCount:[self class] where:where];
}
...
-(NSString *)debugDescription
{
    ...
    [self mutableString:sb appendPropertyStringWithClass:clazz containParent:NO];
    return sb;
}
